(function(root, factory) {
    ...
    return function() {
        ...
        Resultset.prototype.sort = function(comparefun) {
            ...
            var wrappedComparer = function(userComparer, rslt) {
                return function(a, b) {
        ...
        Resultset.prototype.simplesort = function(propname, isdesc) {
            ...
            var wrappedComparer = function(prop, desc, rslt) {
                return function(a, b) {
                    var obj1 = rslt.collection.data[a];
                    var obj2 = rslt.collection.data[b];
        ...
        Resultset.prototype.compoundsort = function(properties) {
            ...
            var wrappedComparer = function(props, rslt) {
                return function(a, b) {
                    var obj1 = rslt.collection.data[a];
                    var obj2 = rslt.collection.data[b];
        ...
        Resultset.prototype.find = function(query, firstOnly) {
            ...
            var queryObject = query || "getAll",
                property, value, operator, p, key, searchByIndex = false,
                result = [],
                index = null,
                fun, t, i, emptyQO = true;
            ...
            if ((!this.searchIsChained || this.searchIsChained && !this.filterInitialized) && operator !== "$ne" && operator !== "$regex" && operator !== "$contains" && operator !== "$containsAny" && operator !== "$in" && this.collection.binaryIndices.hasOwnProperty(property)) {
        ...
        Resultset.prototype.eqJoin = function(joinData, leftJoinKey, rightJoinKey, mapFun) {
            var leftData = [],
                ...
                obj, leftKeyisFunction = typeof leftJoinKey === "function",
        ...
        Collection.prototype.ensureIndex = function(property, force) {
            ...
            var wrappedComparer = function(prop, coll) {
                return function(a, b) {
        ...
        Collection.prototype.add = function(obj) {
            var i, dvlen = this.DynamicViews.length;
                ...
                Object.keys(self.constraints.unique).forEach(function(key) {
                    if (obj.hasOwnProperty(key)) {
                        if (self.constraints.unique[key][obj[key]]) {
                            self.emit("error", "Duplicate key for key " + key + " (value " + obj[key] + " + already in collection)");
                            self.data.pop();
        ...
        Collection.prototype.by = function(field, value) {
            ...
            return this.constraints.unique[field] && this.constraints.unique[field][value] ? this.constraints.unique[field][value] : undefined
        };
